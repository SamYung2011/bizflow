export const Icon = ({ name, size = 18 }) => {
  const icons = {
    ...
    charger: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M7 2h8v9a4 4 0 0 1-8 0V2z"/><path d="M10 6h2"/><path d="M10 10h2"/><path d="M11 15v7"/><path d="M17 7h1a3 3 0 0 1 3 3v5a3 3 0 0 1-3 3h-1"/></svg>,
    chevron_down: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="6 9 12 15 18 9"/></svg>,
  };
