...
P0 added the dormant native SPA foundation. P1 enabled Home and the four OCPP pages; P2 added customers; P3 added orders; P4 adds inventory and finance. Routes not yet migrated keep their existing MPA navigation and per-page boot behavior.
...
- P1 migrates Home and the four OCPP pages first; P2 adds customers; P3 adds orders; P4 adds inventory and finance. Bizflow and Team stay separate SPA sections until all approved pages have migrated; only then may `spaCrossSectionNavigation` be enabled.
