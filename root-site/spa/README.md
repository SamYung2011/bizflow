...
P0 added the dormant native SPA foundation. P1 enabled Home and the four OCPP pages; P2 added the customer domain; P3 adds the order list/create/detail domain. Routes not yet migrated keep their existing MPA navigation and per-page boot behavior.
...
- P1 migrates Home and the four OCPP pages first; P2 adds customers; P3 adds orders. Bizflow and Team stay separate SPA sections until all approved pages have migrated; only then may `spaCrossSectionNavigation` be enabled.
