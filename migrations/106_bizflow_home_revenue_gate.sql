-- 106: prevent Home revenue metrics from leaking to employees without revenue access
...
-- Rollback (manual, outside this migration): reapply migration 105 to restore
